...
I use it regularly on both Mac and Linux terminals but I think it should work fine on any terminal that supports [ANSI colours](http://en.wikipedia.org/wiki/ANSI_escape_code#Colors).
